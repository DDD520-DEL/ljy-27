...
export const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  return (
    <div
      className={`fixed inset-y-0 right-0 w-80 bg-[#F8F5F0] dark:bg-gray-800 shadow-2xl z-40 transform transition-transform duration-300 ease-out ${
      ...
      <div className="h-full flex flex-col">
        <div className="p-5 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">筛选条件</h2>
            </div>
            <button
              onClick={onClose}
          ...
          {hasActiveFilters && (
            <button
              onClick={onReset}
              className="mt-3 flex items-center gap-1.5 text-sm text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300"
            >
              <RotateCcw size={14} />
              重置筛选
            </button>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <label className="font-medium text-gray-700 dark:text-gray-200">综合评分</label>
            </div>
            <div className="flex items-center gap-3">
              <input
                ...
                className="flex-1 h-2 bg-gray-200 dark:bg-gray-600 rounded-lg appearance-none cursor-pointer accent-emerald-600 dark:accent-emerald-500"
              />
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Sofa size={16} className="text-emerald-600 dark:text-emerald-400" />
              <label className="font-medium text-gray-700 dark:text-gray-200">坐感舒适度</label>
            </div>
            <div className="flex items-center gap-3">
              <input
                type="range"
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Trees size={16} className="text-green-500 dark:text-green-400" />
              <label className="font-medium text-gray-700 dark:text-gray-200">遮阴效果</label>
            </div>
            <div className="flex items-center gap-3">
              <input
                type="range"
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <label className="font-medium text-gray-700 dark:text-gray-200">视野好坏</label>
            </div>
            <div className="flex items-center gap-3">
              <input
                type="range"
          ...
          <div>
            <label className="font-medium text-gray-700 dark:text-gray-200 block mb-3">快捷筛选</label>
            <button
              ...
              className={`w-full px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 ${
                filters.onlyFavorites
                  ...
                  : 'bg-white dark:bg-gray-700 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-600 hover:border-red-300 dark:hover:border-red-500'
              }`}
            >
        ...
        <div className="p-5 border-t border-gray-200 dark:border-gray-700 space-y-3">
          <button
            ...
            className="w-full py-3 rounded-xl bg-white dark:bg-gray-700 border border-emerald-200 dark:border-emerald-700 text-emerald-700 dark:text-emerald-400 font-medium hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-colors flex items-center justify-center gap-2"
          >
            <Share2 size={18} />
            生成分享链接
          </button>
            ...
            <div className="p-5 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">分享筛选结果</h3>
                </div>
                <button
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  value={shareUrl}
                  readOnly
                  className="flex-1 px-3 py-2.5 rounded-xl bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-sm text-gray-700 dark:text-gray-200 outline-none"
                />
                <button
