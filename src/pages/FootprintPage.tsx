      ...
      <div className="max-w-3xl mx-auto p-4 md:p-6">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">签到足迹</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">记录你发现的每一个舒适歇脚点</p>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
              <div className="text-3xl font-bold text-emerald-600 dark:text-emerald-400">{totalCount}</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">总签到次数</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
              <div className="text-3xl font-bold text-teal-600 dark:text-teal-400">{Object.keys(groupedCheckIns).length}</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">活跃月份</div>
            </div>
          </div>
        </div>
        ...
        {sortedCheckIns.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-12 text-center shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
            <div className="w-20 h-20 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center mx-auto mb-4">
              <Footprints size={40} className="text-emerald-600 dark:text-emerald-400" />
            </div>
            <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">还没有签到记录</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-4">快去打卡你发现的第一个歇脚点吧</p>
            <button
            ...
            <div className="relative">
              <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-emerald-200 dark:from-emerald-800 to-transparent" />
              
              {Object.entries(groupedCheckIns).map(([month, records]) => (
                <div key={month} className="mb-8">
                  <div className="flex items-center gap-3 mb-4 sticky top-0 bg-[#F8F5F0] dark:bg-gray-900 py-2 z-10 transition-colors duration-300">
                    <div className="w-12 h-12 rounded-full bg-emerald-600 dark:bg-emerald-500 flex items-center justify-center shadow-md">
                      <Calendar size={20} className="text-white" />
                    </div>
                    <div>
                      <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">{month}</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{records.length} 次签到</p>
                    </div>
                  </div>
                  ...
                  <div className="ml-6 space-y-4">
                    {records.map((checkIn, index) => (
                      ...
                      >
                        <div className="absolute left-[-22px] top-6 w-4 h-4 rounded-full bg-emerald-500 border-4 border-[#F8F5F0] dark:border-gray-900 shadow-sm" />
                        
                        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-3 mt-3 flex-wrap">
                                <span className="px-2 py-1 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs">
                              ...
                              {checkIn.note && (
                                <p className="text-sm text-gray-600 dark:text-gray-300 mt-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                  "{checkIn.note}"
                                </p>
                              )}
